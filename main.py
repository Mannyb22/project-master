...
class HomeHandler(webapp2.RequestHandler):
    def get(self):
        ...
        self.response.write(content.render(user = user))
...
class ElectronicsHandler(webapp2.RequestHandler):
    ...
    <img height="100px" width="100px" src="data:image/jpg;base64,%s">
      <br>
      <br>
      <label class="username"> Username: %s</label> <br>
    ...
    </div>) ''' % (s,user.username, post.product_name,post.product_description,post.trade_request))
